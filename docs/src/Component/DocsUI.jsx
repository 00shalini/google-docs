      ...
      >
        <div className="flex pt-5 w-full h-20 border-b-slate-300 border">
          ...
          <div>
            <button
              ...
              className=" w-8 h-8 mr-3 text-l text-white font-bold rounded-full bg-[#3c4043]"
              style={{ marginTop: "-3px" }}
            >
              X
            </button>
        ...
        <div className="w-50 h-24 pl-8 pt-1.5 border-b-slate-300 border">
          <div className="flex mb-4">
            ...
            <p className="text-[#3c4043] font-bold text-sm ml-2 mt-2">
              Settings
            </p>
          </div>
          <div className="flex  mb-4">
            <img src={question} className="w-6 ml-1" />
            <p className="text-[#3c4043] font-bold text-sm ml-4 mt-1">
              Help & feedback
            </p>
          </div>
        </div>
        ...
        <p className="text-[#5f6368] font-extralight text-xs ml-20 hover:text-[#3c4043] mt-28">
      ...
      <div className="main w-full">
        <div className="header flex">
          ...
          <div className="" style={{ width: "450px" }}>
            ...
            <div className="tool-bar-cont flex  w-full justify-around">
              <div
                className="tool-bar-cont1 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className=" text-[#202124] tracking-wide cursor-pointer"
                  id="file-id"
                >
                  File
                </div>
                ...
                <div
                  className={` w-80 bg-white z-50 h-56 overflow-y-scroll ${
                    fileDrop ? "show" : "hide"
                  }`}
                >
                  ...
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-3 mt-2.5">Email</p>
                  </div>
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      src={download}
              ...
              <div
                className="tool-bar-cont2 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar2 text-[#202124] tracking-wide cursor-pointer"
                  id="edit-id"
                >
                  Edit
                </div>
                ...
                <div
                  className={` w-80 bg-white z-50 h-72 overflow-y-scroll ${
                    editDrop ? "show" : "hide"
                  }`}
                >
                  <div className=" w-full h-9 mt-2 flex div-hover">
              ...
              <div
                className="tool-bar-cont3 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar3 text-[#202124] tracking-wide cursor-pointer"
                  id="view-id"
                >
                  View
                </div>
                ...
                <div
                  className={` w-96 bg-white z-50 h-72 overflow-y-scroll ${
                    viewDrop ? "show" : "hide"
                  }`}
                >
                  ...
                  <div className=" w-full h-9 flex div-hover">
                    ...
                    <p
                      className="ml-28 mt-2.5 font-semibold text-right"
                      style={{ color: " rgb(92, 92, 92)" }}
                    >
                  ...
                  <div className=" w-full h-9 flex div-hover">
                    ...
                    <p
                      className="mt-2.5 font-semibold text-right"
                      style={{ color: " rgb(92, 92, 92)", marginLeft: "90px" }}
                    >
                      Ctrl+Alt+P
                    </p>
                  </div>
                  <div className=" w-full h-9 mt-5 flex div-hover">
                    <img
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-5 mt-2.5">Full screen</p>
                  </div>
                </div>
              </div>
              <div
                className="tool-bar-cont4 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar4 text-[#202124] tracking-wide cursor-pointer"
                  id="insert-id"
                >
                  Insert
                </div>
                ...
                >
                  ...
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-3 mt-2.5">Drop down</p>
                  </div>
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      src={omega}
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-3 mt-2.5">Special characters</p>
                  </div>
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      src={pi}
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-3 mt-2.5">Equation</p>
                  </div>
                  <div className=" w-full h-9 flex div-hover">
                    <img
                      src={hashtag}
                      ...
                      className="w-4 h-4 mt-2.5 ml-2"
                    />
                    <p className="ml-3 mt-2.5">Page numbers</p>
                  </div>
                </div>
              </div>
              <div
                className="tool-bar-cont5 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar5 text-[#202124] tracking-wide cursor-pointer"
                  id="format-id"
                >
                  Format
                </div>
              ...
              <div
                className="tool-bar-cont6 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar6 text-[#202124] tracking-wide cursor-pointer"
                  id="tool-id"
                >
                  Tools
                </div>
                ...
                <div
                  className={` w-80 bg-white z-50 h-68 ${
                    toolDrop ? "show" : "hide"
                  }`}
                >
                  <div className=" w-full h-9 mt-2 flex div-hover">
              ...
              <div
                className="tool-bar-cont7 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar7 text-[#202124] tracking-wide cursor-pointer"
                  id="extension-id"
                >
                  Extensions
                </div>
                ...
                <div
                  className={` w-80 bg-white z-50 h-34 ${
                    extensionDrop ? "show" : "hide"
                  }`}
                >
              ...
              <div
                className="tool-bar-cont8 relative inline-block"
                onClick={handleShowDropDown}
              >
                <div
                  className="tool-bar8 text-[#202124] tracking-wide cursor-pointer"
                  id="help-id"
                >
                  Help
                </div>
                ...
                <div
                  className={` w-80 bg-white z-50 h-60 ${
                    helpDrop ? "show" : "hide"
                  }`}
                >
                  <div className=" w-full h-9 mt-3 flex">
                    <input
                      ...
                      className="inp m-auto w-72 h-full outline-none bg-[#e2e4e5] hover:bg-white rounded"
                    />
                  </div>
                  <div className=" w-full h-9 mt-3 flex div-hover">
                    <img
          ...
          <div className=" w-96 ml-80 flex">
            <div className="history-cont w-10">
              <img
                src={history}
                alt="history"
                className="absolute w-5 mt-6 ml-1"
              />
          ...
          >
            ...
            <div className="w-32 h-10">
              ...
              <div className="font-inp-cont w-8 h-10">
                <p className="w-8 font-inp text-center border-slate-600 rounded-sm">
                  {fontSize}
                </p>
              ...
              <div
                className="inc-cont w-6 h-10"
                id="add"
                onClick={handleFontSize}
              >
                <p id="add" className="w-8 inc-txt text-center text-2xl">
                  +
                </p>
            ...
            <div
              className="w-48 h-10 flex pl-2 pr-2"
            ...
            >
              ...
              <div className="text-color-cont w-9 h-10">
                ...
                <div
                  className="border-b-4 border-b-black w-5 m-auto"
                  style={{ marginTop: "-8px" }}
                ></div>
        ...
        <div className="w-full flex pl-7 pt-2">
          <div className="list-with-bullet-cont h-10 w-5">
            ...
            <div className="list-with-bullet w-36 h-6 bg-black text-slate-100 mt-2 pt-0.5 pb-0.5 pl-1.5 pr-1.5 text-xs rounded place-items-center grid">
              Show document outline
            </div>
          </div>
          <div
            className="w-8/12 ml-44 bg-white border"
            style={{ height: "700px" }}
          >
            <textarea
              type="textarea"
              className="w-10/12 h-5/6 mt-14 ml-16 border-none outline-none"
